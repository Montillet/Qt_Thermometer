...
QStringList RS232::recevoir()//int RS232::recevoir(char *ChaineRecue)
{
        BOOL flag_etat;
 ...
 /*-------------------------------------------------------------*/
        ...
        //str.toAscii();
        str.toLatin1();
        buff=str.split(QRegExp("\\s+"));
        //sprintf("%s",ChaineRecue,buffer);   // Retourner la chaine recue
// Liberer la memoire
       // delete[] buffer;
